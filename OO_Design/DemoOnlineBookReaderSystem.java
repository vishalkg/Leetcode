/*
Ref code taken from here: https://discuss.leetcode.com/topic/111787/design-an-online-book-reader-system
Additions:
-> Multiple active users
-> Personal user library for each user

Main Classes:
 |-OnlineReaderSystem: Main class which interfaces from other classes
 |-User
 |-UserManager
 |-Book
 |-Library
